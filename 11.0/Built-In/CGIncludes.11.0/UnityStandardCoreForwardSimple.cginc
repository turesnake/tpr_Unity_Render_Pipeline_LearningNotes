...
void TangentSpaceLightingInput( half3 normalWorld, 
                                half4 vTangent, 
                                half3 lightDirWorld, 
                                half3 eyeVecWorld, 
                                out half3 tangentSpaceLightDir, 
                                out half3 tangentSpaceEyeVec
){
...
VertexOutputBaseSimple vertForwardBaseSimple (VertexInput v)
{
    ...
    o.eyeVec.xyz = eyeVec;
        ...
        TangentSpaceLightingInput(
            normalWorld, v.tangent, _WorldSpaceLightPos0.xyz, eyeVec, 
            o.tangentSpaceLightDir, tangentSpaceEyeVec
        );
        #if SPECULAR_HIGHLIGHTS
...
VertexOutputForwardAddSimple vertForwardAddSimple (VertexInput v)
{
    ...
    half3 normalWorld = UnityObjectToWorldNormal(v.normal);
        ...
        #if SPECULAR_HIGHLIGHTS
            TangentSpaceLightingInput(
                normalWorld, v.tangent, lightDir, eyeVec, o.lightDir, o.tangentSpaceEyeVec
            );
        #else
            half3 ignore;
...
half4 fragForwardAddSimpleInternal (VertexOutputForwardAddSimple i)
{
    ...
    half3 c = BRDF3DirectSimple(
        s.diffColor, s.specColor, s.smoothness, dot(REFLECTVEC_FOR_SPECULAR(i, s), i.lightDir)
    );
