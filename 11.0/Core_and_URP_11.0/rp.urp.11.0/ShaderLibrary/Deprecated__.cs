...
namespace UnityEngine.Rendering.Universal
{
    public static partial class ShaderInput//ShaderInput__RR
    {
        ...
        [Obsolete(@"ShaderInput.ShadowData was deprecated. Shadow slice matrices and per-light shadow parameters 
            are now passed to the GPU using entries in buffers m_AdditionalLightsWorldToShadow_SSBO and m_AdditionalShadowParams_SSBO", 
            false)]
