...
// Some shader compiler don't support to do multiple ## for concatenation(串联) inside the same macro, it require an indirection.
// This is the purpose of this macro
// 一些 shader编译器 不支持在一个 宏指令中, 执行多次 ## 串联操作, 下面的宏 就是用来解决这个问题的
...
#define MILLIMETERS_PER_METER 1000  // 1米有 1000 毫米
#define METERS_PER_MILLIMETER rcp(MILLIMETERS_PER_METER) // rcp() 计算一个快速的倒数
#define CENTIMETERS_PER_METER 100   // 1米有 100 厘米
...
#define FLT_MAX  3.402823466e+38 // Maximum representable(可表示的) floating-point number
