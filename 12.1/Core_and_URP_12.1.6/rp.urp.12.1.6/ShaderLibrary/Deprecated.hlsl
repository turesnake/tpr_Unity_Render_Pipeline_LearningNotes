...
// Deprecated: even when USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA is defined we do not this structure anymore, 
// because worldToShadowMatrix and shadowParams must be stored in arrays of different sizes
