...
#define MAX_SHADOW_CASCADES 4
        ...
        // 需要计算: shadowCoord:
        // _SURFACE_TYPE_TRANSPARENT: 当前为 "半透明" 渲染 (clip不算, 那被算作是 实心的)
...
#endif // USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
...
// 其实就等于定义了 _ADDITIONAL_LIGHT_SHADOWS
...
// d3d 的一种 buffer, 查笔记: structured buffer
#if USE_STRUCTURED_BUFFER_FOR_LIGHT_DATA
