...
half SampleOcclusion(float2 uv)
{
        ...
        // TODO: Controls things like these by exposing SHADER_QUALITY levels (low, medium, high)
            ...
            // 将 occ [0,1] 映射为区间 [1-_OcclusionStrength, 1] 区间; 仍为线性关系
...
{
    half4 albedoAlpha = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap)); // 简单的采样
    outSurfaceData.alpha = Alpha(albedoAlpha.a, _BaseColor, _Cutoff); // 按照不同的 material 配置, 计算出对应的 alpha 值; 同时如有需要, 还执行掉了 clip() 操作;
