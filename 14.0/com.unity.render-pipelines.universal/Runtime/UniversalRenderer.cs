...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        bool CanCopyDepth(ref CameraData cameraData)
        {
            ...
            // copying depth on GLES3 is giving invalid results. 
            // This won't be fixed by the driver team because it would introduce performance issues 
            // (more info in the Fogbugz issue 1339401 comments)
            if (IsGLESDevice())
                return false;
